...
OSErr extractDependenciesASObjC(AEDesc *script_data_ptr, AEDesc *dependencies_ptr, NSString **errmsg)
{
    OSErr err;
    Size datasize;
    ...
    err = extractDependencies(scriptingComponent, script_id, dependencies_ptr, errmsg);
bail:
    AEDisposeDesc(&ocid);
    return err;
}
